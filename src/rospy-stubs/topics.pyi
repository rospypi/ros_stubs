...
class _SubscriberImpl(_TopicImpl[_TMessage]):
    ...
    @overload
    def remove_callback(self, cb: Callable[[_TMessage], None], cb_args: None) -> None: ...
    @overload
    def remove_callback(self, cb: Callable[[_TMessage, _TCallbackArgs], None], cb_args: _TCallbackArgs) -> None: ...
